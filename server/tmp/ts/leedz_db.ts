...
export interface CreateBookingData {
  clientId: string;
  description?: string;
  address?: string;  // Maps to 'location' in schema
  startDate?: Date;
  endDate?: Date;
  startTime?: string;
  endTime?: string;
  ...
  totalAmount?: number;
  status?: string;
  source?: string;  // Maps to 'source' in schema (not sourceEmail)
  notes?: string;
}
...
export interface Booking {
  ...
  location: string | null;  // Maps from 'address' in CreateBookingData
  startDate: Date | null;
  endDate: Date | null;
  ...
  status: string | null;
  source: string | null;  // Maps from schema
  notes: string | null;
  createdAt: Date;
  updatedAt: Date;
}
